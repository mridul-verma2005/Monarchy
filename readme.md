...
> **Note:** Despite the name, this project is completely unrelated to Arch Linux—I just happen to like the concept of a monarchy! Currently, the OS boots successfully from a custom bootloader, transitions into 32-bit Protected Mode, and hands execution over to a C kernel which prints a "Kernel loaded successfully" message.
